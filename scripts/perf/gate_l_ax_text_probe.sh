...
SOURCE_PATH="$REPO_ROOT/scripts/perf/GateLAXTextProbe.swift"
PLIST_TEMPLATE="$REPO_ROOT/scripts/perf/GateLAXTextProbe-Info.plist"
APP_DIR="$REPO_ROOT/scripts/perf/.apps"
APP_BUNDLE="$APP_DIR/GateLAXTextProbe.app"
CONTENTS_DIR="$APP_BUNDLE/Contents"
MACOS_DIR="$CONTENTS_DIR/MacOS"
BIN_PATH="$MACOS_DIR/gate_l_ax_text_probe"
